...
Thanks for your interest in contributing to Maestrist! We welcome and appreciate contributions.

## Understanding Maestrist's CodeBase

To understand the codebase, please refer to the README in each module:
- [frontend](./frontend/README.md)
- [maestrist](./openhands/README.md)
   - [agenthub](./openhands/agenthub/README.md)
   - [server](./openhands/server/README.md)

For benchmarks and evaluation, see the [Maestrist/benchmarks](https://github.com/Maestrist/benchmarks) repository.

## Setting up Your Development Environment

We have a separate doc [Development.md](https://github.com/Maestrist/Maestrist/blob/main/Development.md) that tells
...
1. **Download and use** Maestrist, and send [issues](https://github.com/Maestrist/Maestrist/issues) when you encounter something that isn't working or a feature that you'd like to see.
...
3. **Improve the Codebase** by sending [PRs](#sending-pull-requests-to-maestrist) (see details below). In particular, we have some [good first issues](https://github.com/Maestrist/Maestrist/labels/good%20first%20issue) that may be ones to start on.
...
Our main agent is the CodeAct agent. You can [see its prompts here](https://github.com/Maestrist/Maestrist/tree/main/openhands/agenthub/codeact_agent).
...
to help expand the capabilities of Maestrist.

#### Adding a new runtime

The agent needs a place to run code and commands. When you run Maestrist on your laptop, it uses a Docker container
to do this by default. But there are other ways of creating a sandbox for the agent.

If you work for a company that provides a cloud-based runtime, you could help us add support for that runtime
by implementing the [interface specified here](https://github.com/Maestrist/Maestrist/blob/main/openhands/runtime/base.py).
...
## Sending Pull Requests to Maestrist
...
You may also check out previous PRs in the [PR list](https://github.com/Maestrist/Maestrist/pulls).
...
If you notice any bugs or have any feature requests please open them via the [issues page](https://github.com/Maestrist/Maestrist/issues). We will triage
