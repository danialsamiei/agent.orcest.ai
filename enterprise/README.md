...
This directory contains the enterprise server used by [Maestrist Cloud](https://github.com/danialsamiei/Maestrist-Cloud/). The official, public version of Maestrist Cloud is available at
[app.orcest.ai](https://app.orcest.ai).

You may also want to check out the MIT-licensed [Maestrist](https://github.com/danialsamiei/agent.orcest.ai)
...
- Enterprise overrides the implementation in Maestrist (only one is present at a time). For example, the server config SaasServerConfig overrides [`ServerConfig`](https://github.com/danialsamiei/agent.orcest.ai/blob/main/openhands/server/config/server_config.py#L8) in Maestrist. This is done through dynamic imports ([see here](https://github.com/danialsamiei/agent.orcest.ai/blob/main/openhands/server/config/server_config.py#L37-#L45))
